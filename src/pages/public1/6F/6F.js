...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    //阶梯教室615
    let box615 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id615"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '615',
      '',
      '40px',
    ...
    box615.position.set(142, 0, -300);
    //阶梯教室613
    let box613 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id613"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '613',
      '',
      '40px',
    ...
    stairs_614.position.set(147, 0, -115);
    ...
    //603
    let box603 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id603"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '603',
      '',
      '',
    ...
    box603.position.set(-8, 0, 17);
    //605
    let box605 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id605"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '605',
      '',
      '',
    ...
    //611
    let box611 = getGeometryBox(
      182,
      wall_height,
      105,
      roomStatus["id611"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '611',
      '',
      '',
    ...
    box611.position.set(230, 0, 303);
    //609
    let box609 = getGeometryBox(
      180,
      wall_height,
      105,
      roomStatus["id609"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '609',
      '',
      '',
    ...
    box609.position.set(46, 0, 303);
    //楼梯
    let stairs_609 = getGeometryBox(
      55,
      wall_height,
      130,
      '0xb4b4b4',
    ...
    stairs_609.position.set(-75, 0, 315);
    //607
    let box607 = getGeometryBox(
      177,
      wall_height,
      105,
      roomStatus["id607"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '607',
      '',
      '',
    ...
    box607.position.set(-194, 0, 303);    

    let group = new Group();
    // group.add(box204, boxA4, boxA5, boxA6, boxA7, boxA8, boxA9, groupL, boxA13, boxA14, liftGroup);
    group.add(box613,box615,wall1,wall2,wall3,wall4,wall5,wall6,stairs_614,wall7,stairs,box603,box605,plumbing_well,electric_well,neiting1,neiting2,wall8,box611,box609,stairs_609,box607
