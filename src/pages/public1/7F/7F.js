...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    //阶梯教室715
    let box715 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id715"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '715',
      '',
      '40px',
    ...
    box715.position.set(142, 0, -300);
    //阶梯教室713
    let box713 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id713"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '713',
      '',
      '40px',
    ...
    stairs_714.position.set(147, 0, -115);
    ...
    //703
    let box703 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id703"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '703',
      '',
      '',
    ...
    box703.position.set(-8, 0, 17);
    //705
    let box705 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id705"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '705',
      '',
      '',
    ...
    //711
    let box711 = getGeometryBox(
      182,
      wall_height,
      105,
      roomStatus["id711"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '711',
      '',
      '',
    ...
    box711.position.set(230, 0, 303);
    //709
    let box709 = getGeometryBox(
      180,
      wall_height,
      105,
      roomStatus["id709"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '709',
      '',
      '',
    ...
    box709.position.set(46, 0, 303);
    //楼梯
    let stairs_709 = getGeometryBox(
      55,
      wall_height,
      130,
      '0xb4b4b4',
    ...
    stairs_709.position.set(-75, 0, 315);
    //707
    let box707 = getGeometryBox(
      177,
      wall_height,
      105,
      roomStatus["id707"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '707',
      '',
      '',
    ...
    box707.position.set(-194, 0, 303);    

    let group = new Group();
    // group.add(box204, boxA4, boxA5, boxA6, boxA7, boxA8, boxA9, groupL, boxA13, boxA14, liftGroup);
    group.add(box713,box715,wall1,wall2,wall3,wall4,wall5,wall6,stairs_714,wall7,stairs,box703,box705,plumbing_well,electric_well,neiting1,neiting2,wall8,box711,box709,stairs_709,box707
