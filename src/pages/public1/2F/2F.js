...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    //阶梯教室219
    let box219 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id219"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '219',
      '',
      '40px',
    ...
    box219.position.set(142, 0, -300);
    //阶梯教室217
    let box217 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id217"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '217',
      '',
      '40px',
    ...
    group.add(box219,box217,wall1,wall2,wall3,wall4,wall5,wall6,stairs_218,wall7,stairs,box206,box204,box202,plumbing_well,electric_well,neiting1,neiting2,wall8,warehouse,SJTUBWC,box214,stairs_214,office
