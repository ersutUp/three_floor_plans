...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    //阶梯教室815
    let box815 = getGeometryBox(
      240,
      wall_height,
      150,
      roomStatus["id815"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '815',
      '',
      '40px',
    ...
    //803
    let box803 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id803"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '803',
      '',
      '',
    ...
    box803.position.set(-8, 0, 17);
    //805
    let box805 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id805"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '805',
      '',
      '',
    ...
    //807
    let box807 = getGeometryBox(
      100,
      wall_height,
      122,
      roomStatus["id807"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '807',
      '',
      '',
    ...
    box807.position.set(-293, 0, 160);


    //813
    let box813 = getGeometryBox(
      182,
      wall_height,
      105,
      roomStatus["id813"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '813',
      '',
      '',
    ...
    box813.position.set(230, 0, 303);
    //811
    let box811 = getGeometryBox(
      180,
      wall_height,
      105,
      roomStatus["id811"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '811',
      '',
      '',
    ...
    box811.position.set(46, 0, 303);
    //楼梯
    let stairs_811 = getGeometryBox(
      55,
      wall_height,
      130,
      '0xb4b4b4',
    ...
    stairs_811.position.set(-75, 0, 315);
    //809
    let box809 = getGeometryBox(
      177,
      wall_height,
      105,
      roomStatus["id809"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '809',
      '',
      '',
    ...
    box809.position.set(-194, 0, 303);    

    let group = new Group();
    // group.add(box204, boxA4, boxA5, boxA6, boxA7, boxA8, boxA9, groupL, boxA13, boxA14, liftGroup);
    group.add(box815,wall1,wall2,storeroom,storeroom2,hovel,wall5,wall6,stairs_814,wall7,stairs,box803,box805,plumbing_well,electric_well,neiting1,neiting2,wall8,box807,wall9
      ,box813,box811,stairs_811,box809
