...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    //阶梯教室415
    let box415 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id415"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '415',
      '',
      '40px',
    ...
    box415.position.set(142, 0, -300);
    //阶梯教室413
    let box413 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id413"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '413',
      '',
      '40px',
    ...
    box403.position.set(-8, 0, 17);
    //405
    let box405 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id405"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '405',
      '',
      '',
    ...
    //411
    let box411 = getGeometryBox(
      182,
      wall_height,
      105,
      roomStatus["id411"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '411',
      '',
      '',
    ...
    box409.position.set(46, 0, 303);
    //楼梯
    let stairs_409 = getGeometryBox(
      55,
      wall_height,
      130,
      '0xb4b4b4',
    ...
    stairs_409.position.set(-75, 0, 315);
    //407
    ...
    box407.position.set(-194, 0, 303);    

    let group = new Group();
    // group.add(box204, boxA4, boxA5, boxA6, boxA7, boxA8, boxA9, groupL, boxA13, boxA14, liftGroup);
    group.add(box415,box413,wall1,wall2,wall3,wall4,wall5,wall6,stairs_414,wall7,stairs,box403,box405,plumbing_well,electric_well,neiting1,neiting2,wall8,box411,box409,stairs_409,box407
