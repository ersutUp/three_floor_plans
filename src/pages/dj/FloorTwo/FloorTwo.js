...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    let box201 = getGeometryBox(
      ...
      wall_height,
      156,
      roomStatus["id201"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '201',
      '',
      '',
    ...
    let box203 = getGeometryBox(
      ...
      wall_height,
      156,
      roomStatus["id203"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '203',
      '',
      '',
    ...
    let box207 = getGeometryBox(
      ...
      wall_height,
      156,
      roomStatus["id207"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '207',
      '',
      '',
