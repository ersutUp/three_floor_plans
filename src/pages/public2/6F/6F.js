...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    //阶梯教室614
    let box614 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id614"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '614',
      '',
      '40px',
    ...
    box614.position.set(-142, 0, -300);
    //阶梯教室616
    let box616 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id616"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '616',
      '',
      '40px',
    ...
    //604
    let box604 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id604"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '604',
      '',
      '',
    ...
    box604.position.set(8, 0, 17);
    //602
    let box602 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id602"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '602',
      '',
      '',
    ...
    //608
    let box608 = getGeometryBox(
      182,
      wall_height,
      105,
      roomStatus["id608"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '608',
      '',
      '',
    ...
    box608.position.set(-230, 0, 303);
    //610
    let box610 = getGeometryBox(
      180,
      wall_height,
      105,
      roomStatus["id610"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '610',
      '',
      '',
    ...
    box610.position.set(-46, 0, 303);
    //楼梯
    let stairs_610 = getGeometryBox(
      55,
      wall_height,
      130,
      '0xb4b4b4',
    ...
    stairs_610.position.set(75, 0, 315);
    //612
    let box612 = getGeometryBox(
      177,
      wall_height,
      105,
      roomStatus["id612"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '612',
      '',
      '',
    ...
    box612.position.set(194, 0, 303);    

    let group = new Group();
    // group.add(box204, boxA4, boxA5, boxA6, boxA7, boxA8, boxA9, groupL, boxA13, boxA14, liftGroup);
    group.add(box614,box616,wall1,wall2,wall3,wall4,wall5,wall6,stairs_614,wall7,stairs,box604,box602,plumbing_well,electric_well,neiting1,neiting2,wall8,box608,box610,stairs_610,box612
