...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    //阶梯教室218
    let box218 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id218"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '218',
      '',
      '40px',
    ...
    //阶梯教室220
    let box220 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id220"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '220',
      '',
      '40px',
    ...
    let box206 = getGeometryBox(
      ...
      wall_height,
      105,
      roomStatus["id206"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '206',
      '',
      '',
    ...
    let box204 = getGeometryBox(
      ...
      wall_height,
      105,
      roomStatus["id204"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '204',
      '',
      '',
    ...
    let box202 = getGeometryBox(
      ...
      wall_height,
      105,
      roomStatus["id202"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '202',
      '',
      '',
    ...
    let box214 = getGeometryBox(
      ...
      wall_height,
      105,
      roomStatus["id214"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '214',
      '',
      '',
