...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    let box514 = getGeometryBox(
      ...
      wall_height,
      150,
      roomStatus[514] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '514',
      '',
      '40px',
    ...
    let box516 = getGeometryBox(
      ...
      wall_height,
      150,
      roomStatus[516] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '516',
      '',
      '40px',
    ...
    let box504 = getGeometryBox(
      ...
      wall_height,
      105,
      roomStatus[504] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '504',
      '',
      '',
    ...
    let box502 = getGeometryBox(
      ...
      wall_height,
      105,
      roomStatus[502] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '502',
      '',
      '',
    ...
    let box508 = getGeometryBox(
      ...
      wall_height,
      105,
      roomStatus[508] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '508',
      '',
      '',
    ...
    let box510 = getGeometryBox(
      ...
      wall_height,
      105,
      roomStatus[510] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '510',
      '',
      '',
    ...
    let box512 = getGeometryBox(
      ...
      wall_height,
      105,
      roomStatus[512] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '512',
      '',
      '',
