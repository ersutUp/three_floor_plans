...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    //阶梯教室514
    let box514 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id514"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '514',
      '',
      '40px',
    ...
    box514.position.set(-142, 0, -300);
    //阶梯教室516
    let box516 = getGeometryBox(
      120,
      wall_height,
      150,
      roomStatus["id516"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '516',
      '',
      '40px',
    ...
    //504
    let box504 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id504"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '504',
      '',
      '',
    ...
    box504.position.set(8, 0, 17);
    //502
    let box502 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id502"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '502',
      '',
      '',
    ...
    //508
    let box508 = getGeometryBox(
      182,
      wall_height,
      105,
      roomStatus["id508"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '508',
      '',
      '',
    ...
    box508.position.set(-230, 0, 303);
    //510
    let box510 = getGeometryBox(
      180,
      wall_height,
      105,
      roomStatus["id510"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '510',
      '',
      '',
    ...
    box510.position.set(-46, 0, 303);
    //楼梯
    let stairs_510 = getGeometryBox(
      55,
      wall_height,
      130,
      '0xb4b4b4',
    ...
    stairs_510.position.set(75, 0, 315);
    //512
    let box512 = getGeometryBox(
      177,
      wall_height,
      105,
      roomStatus["id512"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '512',
      '',
      '',
    ...
    box512.position.set(194, 0, 303);    

    let group = new Group();
    // group.add(box204, boxA4, boxA5, boxA6, boxA7, boxA8, boxA9, groupL, boxA13, boxA14, liftGroup);
    group.add(box514,box516,wall1,wall2,wall3,wall4,wall5,wall6,stairs_514,wall7,stairs,box504,box502,plumbing_well,electric_well,neiting1,neiting2,wall8,box508,box510,stairs_510,box512
