...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    let box414 = getGeometryBox(
      ...
      wall_height,
      150,
      roomStatus["id414"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '414',
      '',
      '40px',
    ...
    let box416 = getGeometryBox(
      ...
      wall_height,
      150,
      roomStatus["id416"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '416',
      '',
      '40px',
    ...
    let box410 = getGeometryBox(
      ...
      wall_height,
      105,
      roomStatus["id410"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '410',
      '',
      '',
    ...
    let box412 = getGeometryBox(
      ...
      wall_height,
      105,
      roomStatus["id412"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '412',
      '',
      '',
