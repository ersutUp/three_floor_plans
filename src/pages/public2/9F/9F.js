...
class FloorTwo extends Component {
  ...
  initGeometryBox = () => {
    ...
    //阶梯教室916
    let box916 = getGeometryBox(
      240,
      wall_height,
      150,
      roomStatus["id916"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '916',
      '',
      '40px',
    ...
    storeroom2.position.set(-288, 0, -172);
    //库房
    let storeroom = getGeometryBox(
      65,
      wall_height,
      52,
      '0xb4b4b4',
    ...
    storeroom.position.set(-288, 0, -117);
    //杂物间
    let hovel = getGeometryBox(
      65,
      wall_height,
      52,
      '0xb4b4b4',
    ...
    stairs_914.position.set(-147, 0, -115);
    ...
    //904
    let box904 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id904"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '904',
      '',
      '',
    ...
    box904.position.set(8, 0, 17);
    //902
    let box902 = getGeometryBox(
      179,
      wall_height,
      105,
      roomStatus["id902"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '902',
      '',
      '',
    ...
    wall8.position.set(245, 0, 85);
    let wall9 = getGeometryBox(
      5,
      wall_height,
      28,
      '0x4180c4',
    ...
    wall9.position.set(245, 0, 235);
    //906
    let box906 = getGeometryBox(
      100,
      wall_height,
      122,
      roomStatus["id906"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '906',
      '',
      '',
    ...
    box906.position.set(293, 0, 160);


    //908
    let box908 = getGeometryBox(
      182,
      wall_height,
      105,
      roomStatus["id908"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '908',
      '',
      '',
    ...
    box908.position.set(-230, 0, 303);
    //910
    let box910 = getGeometryBox(
      180,
      wall_height,
      105,
      roomStatus["id910"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '910',
      '',
      '',
    ...
    box910.position.set(-46, 0, 303);
    //楼梯
    let stairs_910 = getGeometryBox(
      55,
      wall_height,
      130,
      '0xb4b4b4',
    ...
    stairs_910.position.set(75, 0, 315);
    //912
    let box912 = getGeometryBox(
      177,
      wall_height,
      105,
      roomStatus["id912"] === 0 ?free_room_color:in_class_room_color,
      'meshA1',
      '912',
      '',
      '',
    ...
    box912.position.set(194, 0, 303);    

    let group = new Group();
    // group.add(box204, boxA4, boxA5, boxA6, boxA7, boxA8, boxA9, groupL, boxA13, boxA14, liftGroup);
    group.add(box916,wall1,wall2,storeroom,storeroom2,hovel,wall5,wall6,stairs_914,wall7,stairs,box904,box902,plumbing_well,electric_well,neiting1,neiting2,wall8,box906,wall9
      ,box908,box910,stairs_910,box912
      ,lounge,toilet,elevator);
    // group.rotation.set(0, -Math.PI / 190 * 45, 0);
